        ...
        <div style={{ fontFamily: 'sans-serif', minHeight: '100vh', background: '#0f1117', color: '#fff' }}>
            <div style={{ textAlign: 'center', padding: '4rem 2rem 2rem' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
                    ...
                    <button onClick={() => navigate('/register')} style={{ background: 'transparent', color: '#fff', border: '1px solid #333', padding: '12px 24px', borderRadius: '8px', fontSize: '15px', fontWeight: 500, cursor: 'pointer' }}>
                        Register
                    </button>
                </div>
            </div>
