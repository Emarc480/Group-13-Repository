...
urlpatterns = [
    ...
    path('api/student/issues/<int:issue_id>/',
         issue_detail, name='issue-detail'),
    path('api/student/issues/<int:issue_id>/edit/',
         edit_issue, name='edit-issue'),
    path('api/student/issues/<int:issue_id>/withdraw/',
         withdraw_issue, name='withdraw-issue'),
    ...
    path('api/registrar/dashboard/', registrar_dashboard,
         name='registrar-dashboard'),
    path('api/registrar/all-issues/', registrar_all_issues,
         name='registrar-all-issues'),
    path('api/registrar/update-issue/<int:issue_id>/',
         registrar_update_issue, name='registrar-update'),
]
